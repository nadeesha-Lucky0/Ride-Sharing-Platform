...
| :--- | :--- | :--- | :--- |
| **`account-service/`** | **Member 1** | `8081` | Authentication (JWT), User registration, Passenger & Driver profiles |
| **`driver-service/`** | **Member 2** | `8082` | Driver availability, vehicle management, and geolocation updates |
| **`ride-service/`** | **Member 3** | `8083` | Ride request lifecycle, driver matching orchestrator, and status updates |
| **`payment-service/`** | **Member 4** | `8084` | Fare estimation calculation, payment processing, and digital receipts |
...
│
├── account-service/                      # [Member 1's Folder] Account Service
...
│   └── pom.xml
│
├── driver-service/                       # [Member 2's Folder] Driver & Vehicle Service
...
│   └── pom.xml
│
├── ride-service/                         # [Member 3's Folder] Ride Management Service
...
│   └── pom.xml
│
└── payment-service/                      # [Member 4's Folder] Fare & Payment Service
...
### Member 1: Account Service (`http://localhost:8081`)
- `POST /api/auth/register` - Register a new user (RIDER or DRIVER)
- `POST /api/auth/login` - Authenticate and get JWT token
- `GET /api/users/{id}` - Get user profile

### Member 2: Driver Service (`http://localhost:8082`)
...
### Member 3: Ride Service (`http://localhost:8083`)
...
### Member 4: Payment Service (`http://localhost:8084`)
